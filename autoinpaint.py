...
from libs.paths_dirs_stuff import get_data_list, creat_dir
from libs.anomaly_tools import get_candid_mask, get_pred_candid
from libs.anomaly_tools import get_organ_mask, gen_random_masks_in_lung
from libs.anomaly_tools import get_circle_candids, get_pred_random_masks
            ...
            if ix>=crop_vol_ind_buttom and ix<n_slice+crop_vol_ind_top:
                ...
                if field_sum_int>40: # instead of 0 avoid tiny structures 
                    if n_random_mask_select>0:
                        ...
                        pred_imgs, corrupt_imgs, resid_ints = get_pred_random_masks(random_masks_selects,main_img,model_multi,organ_mask)
