...
from libs.sitk_stuff import read_nifti
from libs.img_utils import load_img_array2
...
def image_to_nifti(n_subject_nifti, n_subject_input, n_subject_output,
    ...
    for ix in range(n_subject_input):
        ...
        _, _, img_size, img_spacing, img_origin, img_direction = read_nifti(nifti_content[0]) 
        ...
        ct_res_path = os.path.join(write_path_ct_res, subject_name_ct)
        pet_res_path = os.path.join(write_path_pet_res, subject_name_pet)
