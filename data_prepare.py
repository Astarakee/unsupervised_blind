...
import argparse
import numpy as np
from libs.img_utils import normalize
from libs.sitk_stuff import read_nifti
from libs.paths_dirs_stuff import get_sub_dirs, get_data_list, creat_dir
...
def prepare_2d(nifti_subfolders, img_dir, map_dir, ct_pattern, pet_pattern,
    ...
    for item in enumerate(nifti_subfolders):
        ...
        try:
            ct_itk, ct_array, ct_size, _, _, _ = read_nifti(nifti_ct_path)
            pet_itk, pet_array, pet_size, _, _, _ = read_nifti(nifti_pet_path)
