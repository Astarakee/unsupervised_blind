...
parser.add_argument('--upper_cut', type=int, default= 30,  help='skip upper slices', required=False)
parser.add_argument('--lower_cut', type=int, default= 20,  help='skip buttom slices', required=False)
parser.add_argument('--input_dir', type=str, help='Input directory to the nifti volumes', required=False)
parser.add_argument('--output_dir', type=str, help='Output directory to save results and logs', required=False)
...
parser.add_argument('--min_bound_ct', type=int,  default=-1000,  help='CT histogram windowing lower bound', required=False)
parser.add_argument('--pet_pattern', type=str,  default="_pet.nii.gz",  help='Filename patterns of PET nifti volumes', required=False)
parser.add_argument('--ct_pattern', type=str,  default="_ct.nii.gz", help='Filename patterns of CT nifti volumes', required=False)
...
shutil.rmtree(os.path.join(write_dir, '2D'))
